...
- **Database**: MySQL (`tripora_tour_db`)
...
- `TourRepository`: MySQL implementation with soft delete support
...
### Prerequisites
- .NET 10.0 Runtime
- MySQL database and user permissions
...
- `ConnectionStrings__MySqlConnection`: Database connection string
...
- Regular backup of the MySQL database
